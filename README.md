...
- Simple internal redirect manager.
...
No. Administrators can create redirects to internal URLs only. Only users with administrator-level permissions should be allowed to manage redirects.
...
See [GNU General Public License v2.0](https://www.gnu.org/licenses/gpl-2.0.html).
